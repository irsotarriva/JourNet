...
class RecommendationEngine:
    ...
    def __init__(self):
        pass
    def get_recommendation_for_paper(self, embedding: np.ndarray, top_k: int = 5) -> list[paper.Paper]:
    ...
    def get_recommendation(self, positive_embeddings: list[np.ndarray] = [], negative_embeddings: list[np.ndarray] = [], top_k: int = 5, filter: dict = None) -> list[paper.Paper]:
        ...
        recomment_query = models.QueryRequest(
